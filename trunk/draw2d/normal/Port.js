...
{
    var item = draw2d.Rectangle.prototype.createHTMLElement.call(this, true);
...
draw2d.Port.prototype.getUiRepresentation=function()
{
    return this.currentUIRepresentation;
};
...
draw2d.Port.prototype.onDrag = function()
{
  ...
  idUiRep = this.getUiRepresentation().getId();
  $("#"+idUiRep).css("display","none");
};
