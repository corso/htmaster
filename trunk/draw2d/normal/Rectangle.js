 ...
 * @constructor
 */
draw2d.Rectangle=function(/*int*/ width, /*:int*/ height, /*:string*/ subtype)
{
  /** @private **/
  this.bgColor = null;
  /** @private **/
 ...
 * @private
 **/
draw2d.Rectangle.prototype.createHTMLElement=function(port)
{
    var item = draw2d.Figure.prototype.createHTMLElement.call(this, this.subType);
    item.style.width="auto";
    item.style.height="auto";
    item.style.margin="0px";
    item.style.padding="0px";
    item.style.border= this.lineStroke+"px "+this.borderType+" "+this.lineColor.getHTMLStyle();
    item.style.fontSize="14px";
    item.style.borderRadius = this.borderRadius+"px";
